  ...
  $(document).ready(function(){
    $("#type").change(function(){
      if($(this).val() == "1"){ //วัน
        $.ajax({
          type: "POST",
          url: "<?php echo site_url();?>/Project_controller/fetch_withdraw_year",
          method:"POST",
          data:{
            type:$(this).val()
          },
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo site_url();?>/Project_controller/report_withdraw_per_year",
          method:"POST",
          data:{
            type:$(this).val()
          },
