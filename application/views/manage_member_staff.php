        ...
        },
        {
          ...
          render: function(data, type, row){
            ...
            var divv = ' <div class="dropdown">';
                ...
                divv+='<a style="color:black;" href="<?php  echo site_url('Project_controller/member_detail_staff/');?>'+row['member_id']+'"><i class="fa fa-address-book" aria-hidden="true"></i> รายละเอียด</a>';
                divv+='<a style="color:black;" href="<?php  echo site_url('Project_controller/member_update_form_staff/');?>'+row['member_id']+'" ><i class="fa fa-pencil" aria-hidden="true"></i> แก้ไขข้อมูล</a>';
                divv+='<a style="color:black;" id="onclickchangestatus" href="<?php  echo site_url('Project_controller/member_change_status_staff/');?>'+row['member_id']+'" ><i class="fa fa-times" aria-hidden="true"></i> เปลี่ยนสถานะ</a>';
                divv+='</div></div>';                                     
            return divv;
          }
        }
