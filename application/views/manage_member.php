                ...
                <div  class="row">
                  ...
                  <div class="col-md-12 topnav" align="center" >
                    ...
                    <div align="right" class="col-4"> 
                      <a class="link btn btn-outline-primary btn-sm" href="<?php  echo base_url('Project_controller/member_insert_form/'); ?>">เพิ่มสมาชิก</a>
                    </div>    
                  </div>                      
                </div>
                <div class="col-md-12 text-center">
                          ...
                          <td>
                           <div class="dropdown">
                                  ...
                                  <ul style="background-color:#E8ECEF;"  class="dropdown-menu">
                                    <li><a style="color:black;" href="<?php  echo base_url('Project_controller/member_detail/'.$row->member_id); ?>" ><i class="fa fa-address-book" aria-hidden="true"></i>รายละเอียด</a></li>
                                    <li><a style="color:black;" href="<?php  echo base_url('Project_controller/member_update_form/'.$row->member_id); ?>" ><i class="fa fa-pencil" aria-hidden="true"></i> แก้ไขข้อมูล</a></li>
                                    <li><a style="color:black;" onclick="return confirm('ต้องการเปลี่ยนสถานะการใช้งานหรือไม่');" href="<?php  echo base_url('Project_controller/member_change_status/'.$row->member_id); ?>" ><i class="fa fa-times" aria-hidden="true"></i> เปลี่ยนสถานะ</a></li>
                                  </ul>
                                </div>     
                          </td>
                        </tr>
