          ...
          <form enctype="multipart/form-data" name="member_form" id="member_form">
            <div class="row">
              <div class="form-group col-4" align="center">
                ...
                <img onmouseover="this.style.cursor = 'pointer'" id="show_image_pic" width="40%" height= "40%" src="<?php echo $row->member_pic;?>" alt="your image" style="border: solid 1px #c0c0c0;" /> 
