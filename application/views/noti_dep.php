            ...
            <tbody class="table-bordered" style="background-color: #EFFEFD">
              <?php $i=1;  foreach($unconfirm_deposit->result() as $row){ ?>
                <tr>
                  ...
                  <td>
                    <a onclick="return confirm('ยืนยันรายการหรือไม่');" href="<?php  echo base_url('Project_controller/confirm_deposit/'.$row->account_detail_id)."/".$this->session->userdata('id'); ?>" >ยืนยันรายการ</a>
